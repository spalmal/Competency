...
<title>CAP COMPETENCY PIE CHARTS</title>
...
<c:if test="${not empty skills}">
  ...
  <p>
 <form  onsubmit="this.action = '/mvcchart/searchSkill/' + this.name.value"   method="get">
 <span> Enter skill Name : </span><input type="text" id="name"></input>
 <input type="submit" value="Get Pie Charts"></input>
 </form>
 </p>
 <p>
